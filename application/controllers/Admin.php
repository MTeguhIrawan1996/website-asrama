...
class Admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['penghunij'] = $this->penghuni->getJumlahPenghuniKamar();
        $data['penghuniv'] = $this->penghuni->getJumlahPenghuniV();
        $data['penghunid'] = $this->penghuni->getJumlahPenghuniD();
        $data['pindahkamar'] = $this->pindah->getJumlahPindahKamar();
